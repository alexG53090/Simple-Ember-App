...
define('super-rentals/tests/routes/colophon.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - routes');
  QUnit.test('routes/colophon.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/colophon.js should pass jshint.');
  });
});
...
define('super-rentals/tests/unit/routes/colophon-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/routes');
  QUnit.test('unit/routes/colophon-test.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/colophon-test.js should pass jshint.');
  });
});
